...
bowl = '콩';
//console.log(bowl); //콩
//자바스크립트는 절차적 언어이기 때문에 css처럼 우선순위에 따라 최종결과값만 인식하는 것이 아닌 실행 함수의 작성위치에 따라 다른 변수값을 인식할 수 있다.
var a = 1;
var b = 5;
var c = 10;
c = a;
console.log(a);// b의 값 받기 전 a의 기존 값 출력
a = b; //문자 b가 아닌 변수 b를 a에 대입한다(O) 변수를 대입한다=변수값을 대입한다
console.log(b);
b = c;
console.log(c);
//=================자료형 구분 내장함수 typeof
...
console.log('==========데이터공부')
var d;
console.log(typeof d) //값이 할당되지 않은 상태 undefined(오류점검용) 값이 한번도들어가지 않은 상태 보통 오류찾기용으로 많이 씀
d = a;
console.log('d의 값은'+ d);//'d의 값은'+  d 따옴표가 붙은 d는 문자로 처리
console.log('a의 값은'+a);
console.log('b의 값은'+b);
console.log('c의 값은'+c);
console.log('-----------------------')
console.log(1+1); //숫자+숫자 =더하기 결과 2
console.log('1'+1); //뮨자+숫자 =연결결과 11
console.log('-----------------------')
var box1 = 10;
var box2 = 'hello'
var box3 = 'javascript'
...
console.log(`num4 와 num5의 더한 결과값은${num4+num5}입니다.`);
console.log(`----------------------------------`)
var subway = 2500;
var coffee = 7500;
